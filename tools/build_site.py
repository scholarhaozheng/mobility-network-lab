...
<div class="soft"><div class="wrap"><section class="evidence-support"><div class="sectionhead"><h2>Supporting mobility data</h2><p>Reuse selected OMDV implementations where they help city-data preparation. Research summaries remain available as supporting evidence, not as a city-model collection.</p></div><div class="split"><div><p class="eyebrow">Executable data tools</p><h3>Normalize local city and catalog records</h3><p>Transparent named-entity matching preserves unmatched and ambiguous records. The result is metadata—not GPS map matching or an OD estimate.</p><a href="data-tools.html">Data tools →</a></div><div><pre><code>python -m pip install -r requirements-data-tools.txt
