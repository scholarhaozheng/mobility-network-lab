...
def main():
    ...
    files=['docs/capabilities.md','docs/cases/boston.md','docs/cases/boston-assignment.md','docs/cases/sioux-falls.md','docs/cases/sioux-space-time.md','docs/methods/space-time-cg.md','docs/RUN_YOUR_OWN_GMNS.md','docs/BOSTON_SCALE_RESULTS.md','docs/SCALABLE_TOOL_DATA_NOTICE.md']
    for f in files:
