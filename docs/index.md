...
<p><strong>An open-source computational framework for GMNS city models, four-stage demand, static assignment, and finite space–time column generation.</strong></p>
...
<td><strong>Historical 200 / 250 OD:</strong> feasible, with reference-objective agreement on each selected-OD finite time-expanded graph; independent pricing closure <strong>not established</strong></td>
</tr>
<tr>
...
<p><em>Saved-result presentation composite; no scientific model was rerun.</em> <a href="#sioux-falls">Matching Sioux Falls sequence below</a> · <a href="assets/presentation_r5/boston_cg_case_sequence.svg">Editable-text SVG</a> · <a href="assets/presentation_r5/CG_CASE_SEQUENCE_SOURCES.json">Exact source hashes</a>.</p>
<p align="center"><a href="cases/boston-space-time.html"><img alt="Composed summary of the one bounded Boston CG pilot: final physical-link movement flow, Phase-I clearance, Phase-II reference-objective agreement, and 10-of-10 independent pricing closure." src="assets/boston/space_time_cg_r4/boston_cg_summary_panel.png" width="100%"/></a></p>
<div class="table-scroll"><table>
<thead>
<tr>
...
<p><em>Saved-result presentation composite; no scientific model was rerun.</em> <a href="#boston">Matching Boston sequence above</a> · <a href="assets/presentation_r5/sioux_cg_case_sequence.svg">Editable-text SVG</a> · <a href="assets/presentation_r5/CG_CASE_SEQUENCE_SOURCES.json">Exact source hashes</a>.</p>
<div class="table-scroll"><table>
<tr>
