...
| [Sioux Falls · ADMM R2_S 200/250 OD](cases/sioux-admm.md) | Distinct 200/250 selected-OD finite shared-capacity instances | Frozen-policy local QP / capacity projection / scaled dual; accepted independent gates | Matched six-panel composites, schematic maps and figure source sidecars; no per-link numerical CSV |
